...
export function Herosection2() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // 1. Circle expands (0.0 to 0.40)
      const p1 = Math.min(progress / 0.40, 1);
      ...
      // 3. Mascot shifts and fades (0.0 to 1.0)
      let p2 = progress; 
      ...
      if (isMobile) {
         // Mobile: Move TOP-LEFT and scale
         shiftX = p2 * -20; 
         shiftY = p2 * -25; 
         mascotScale = 1 + p2 * 0.4; 
      } else {
         // Desktop: Move TOP-LEFT and scale slightly
         shiftX = p2 * -30; 
         shiftY = p2 * -30; 
         mascotScale = 1 + (p2 * 0.1); 
      }
      ...
      if (mascotRef.current) {
        ...
        mascotRef.current.style.opacity = (1 - p2).toString();
      ...
      // 4. Reveal Left Text Container (0.20 to 0.35)
      let p3 = 0; 
      if (progress > 0.20) p3 = Math.min((progress - 0.20) / 0.15, 1);
      
      if (leftTextRef.current) {
        leftTextRef.current.style.opacity = p3.toString();
        // Add a smooth blur reveal for premium UX
        const blurValue = (1 - p3) * 10;
        leftTextRef.current.style.filter = `blur(${blurValue}px)`;
        
        // Optional: slight upward shift for a more dynamic "coming in" feel
        const translateY = (1 - p3) * 20;
        leftTextRef.current.style.transform = `translateY(${translateY}px)`;
      }
      
      if (progressBarContainerRef.current) {
        progressBarContainerRef.current.style.opacity = p3.toString();
        // Also blur the progress bar container slightly for consistency
        const blurValue = (1 - p3) * 5;
        progressBarContainerRef.current.style.filter = `blur(${blurValue}px)`;
      }
  ...
  return (
    <section 
      ref={containerRef} 
      className="h-[200vh] w-full relative font-sans"
      style={{
    ...
    >
      <div className="sticky top-0 h-[100dvh] w-full flex flex-col justify-between pt-12 pb-8 px-6 md:px-12 overflow-hidden">
        ...
        {/* LEFT INCOMING TEXT CONTAINER (Maintained from original) - COMMENTED OUT AS REQUESTED
        <div 
          ref={leftTextRef} 
          className="absolute top-0 left-0 w-full md:w-[55%] h-full flex flex-col justify-end md:justify-center px-6 sm:px-10 md:px-24 z-40 opacity-0 pointer-events-none pb-24 md:pb-0 will-change-[opacity,filter,transform]"
        >
            <div className="grid w-full text-white">
                ...
                <div ref={text1Ref} className="col-start-1 row-start-1 flex flex-col justify-center transition-opacity duration-300">
                   ...
                   <ul className="flex flex-col gap-y-1.5 text-gray-300 font-light text-sm sm:text-base md:text-lg tracking-wide pl-2">
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Custom Shopify Stores</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Theme Customization</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Conversion Optimization</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>App Integrations</li>
                   </ul>
                </div>
                ...
                <div ref={text2Ref} className="col-start-1 row-start-1 flex flex-col justify-center opacity-0 transition-opacity duration-300">
                   ...
                   <ul className="flex flex-col gap-y-1.5 text-gray-300 font-light text-sm sm:text-base md:text-lg tracking-wide pl-2">
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Scalable Web Apps</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>API Integrations</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Full-Stack Architecture</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Database Design</li>
                   </ul>
                </div>
                ...
                <div ref={text3Ref} className="col-start-1 row-start-1 flex flex-col justify-center opacity-0 transition-opacity duration-300">
                   ...
                   <ul className="flex flex-col gap-y-1.5 text-gray-300 font-light text-sm sm:text-base md:text-lg tracking-wide pl-2">
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Custom Themes</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>SEO Optimization</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Secure Architecture</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Seamless Migrations</li>
                   </ul>
                </div>
                ...
                <div ref={text4Ref} className="col-start-1 row-start-1 flex flex-col justify-center opacity-0 transition-opacity duration-300">
                   ...
                   <ul className="flex flex-col gap-y-1.5 text-gray-300 font-light text-sm sm:text-base md:text-lg tracking-wide pl-2">
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Prototyping &amp; Wireframes</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>User Research</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Journey Mapping</li>
                     <li className="flex items-center gap-3"><span className="w-1.5 h-1.5 bg-gray-300 rounded-full flex-shrink-0"></span>Interface Design</li>
                   </ul>
                </div>
        ...
        */}
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative w-full pt-50 pb-20">
          ...
          <div ref={footerRef} className="w-full flex flex-col gap-4 sm:flex-row sm:justify-between items-center mt-30 relative z-10 will-change-transform pt-40">
        ...
        {/* Segmented Progress Bar (Funtown Studio Style) - COMMENTED OUT AS REQUESTED
        <div 
          ref={progressBarContainerRef} 
          className="absolute bottom-12 left-6 md:left-12 lg:left-24 right-6 md:right-12 lg:right-24 flex gap-4 md:gap-8 z-40 opacity-0 transition-opacity duration-300 pointer-events-none will-change-[opacity,filter]"
        >
